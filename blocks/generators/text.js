...
Blockly.JavaScript['text_enter'] = function (block) {
  var code = "'\\n'";
  return [code, Blockly.JavaScript.ORDER_MEMBER];
};
...
function text_midx_function(t, t1, t2) { return t.slice(t.indexOf(t1) + 1, t.indexOf(t2)) }

Blockly.JavaScript['text_midx'] = function (block) {
  var value_mainstring = Blockly.JavaScript.valueToCode(block, 'mainString', Blockly.JavaScript.ORDER_ATOMIC);
  ...
  var code = value_mainstring + '.slice(' + value_mainstring + '.indexOf(' + value_substring1 + ')+1,' + value_mainstring + '.indexOf(' + value_substring2 + '))';
