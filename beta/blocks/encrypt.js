...
goog.provide('Blockly.Blocks.encrypt');  // Deprecated
goog.provide('Blockly.Constants.encrypt');

goog.require('Blockly.Blocks');

Blockly.Constants.encrypt.HUE = Blockly.Msg["ENCRYPT_HUE"];
Blockly.Blocks.encrypt.HUE = Blockly.Constants.encrypt.HUE;
