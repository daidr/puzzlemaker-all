...
Blockly.JavaScript['math_random_int'] = function (block) {
  ...
  var argument1 = Blockly.JavaScript.valueToCode(block, 'TO',
    Blockly.JavaScript.ORDER_COMMA) || '0';
  var mathRandomRebuildFunctionName = Blockly.JavaScript.provideFunction_(
    'mathRandomRebuild',
    ['var ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + '= (function(){',
      '  var today = new Date();',
      ...
      '  };',
    '  return function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + '(){',
      '    return Math.ceil(rnd(seed) * 100) / 100;',
      '  };',
      '})();']);
  var functionName = Blockly.JavaScript.provideFunction_(
    'mathRandomInt',
    ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
      ...
      '    b = c;',
      '  }',
    '  return Math.floor(' + mathRandomRebuildFunctionName + '() * (b - a + 1) + a);',
      '}']);
...
Blockly.JavaScript['math_random_float'] = function (block) {
  ...
  var functionName = Blockly.JavaScript.provideFunction_(
    ...
    '  return function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + '(){',
      ...
      '  };',
      '})();']);
  return [functionName + '()', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
